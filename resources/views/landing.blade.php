...
<body>
    ...
    <header class="shadow-lg fixed w-full top-0 z-[999] bg-white">
      ...
      <div class="flex justify-between">
        <nav id="navbar" class="w-full relative text-navy py-4 lg:py-6 lg:gap-40 lg:pr-8 lg:flex lg:justify-between">
          ...
          <div id="mobile-menu" class="lg:flex lg:bg-transparent text-left rounded-md hidden lg:right-0 lg:top-0 right-10 top-[100%] absolute flex flex-col z-[150] bg-white md:justify-end pt-2 sm:ml-32 sm:ml-52 text-2xl text-right font-sans lg:flex-row lg:pr-10 lg:gap-x-7 xl:gap-x-20">
    ...
    <main>
      ...
      <!-- Segarkan dapur anda -->
      <div id="Beranda" class="flex flex-col mt-18 lg:flex-row lg:flex lg:justify-between lg:my-40 lg:items-cnter lg:justify-center mx-10 lg:mx-20">
        <div class="mt-32 z-0 lg:px-18 lg:w-1/2 max-w-screen-2xl">
          <h1 style="font-family: 'Playfair Display', serif;" class="text-navy font-sans text-5xl lg:text-6xl mt-8 font-semibold leading-normal lg:leading-[5rem]">Segarkan <span class="text-green">Dapur </span> anda dengan satu <span class="text-green">klik !</span></h1>
          <p class="text-navy text-xl lg:text-2xl lg:mb-20 font-regular mt-8 lg:font-normal lg:leading-normal">Tukang sayur terbaik, kini di ujung jari Anda! Belanja sayuran dan bahan masakan segar langsung dari rumah. Hemat waktu dan nikmati kesegaran tanpa repot, semua lewat aplikasi kami. Belanja mudah dan menyenangkan setiap hari !</p>
          <a href="https://www.figma.com/proto/NSja7GG9TNAxqVqWj8bAeg/Relyst-Cluster-Design?type=design&node-id=184-219&t=44anlpjD6OWSRNSV-1&scaling=scale-down&page-id=176%3A114&starting-point-node-id=247%3A477&show-proto-sidebar=1&mode=design"><button class="transition duration-300 flex w-full lg:w-1/2 flex justify-center items-center font-sans border border-2 border-green mt-8 px-[26] lg:p-4 py-2 text-3xl text-green rounded-lg cursor-pointer hover:text-white hover:bg-green gap-x-2 lg:gap-x-4 group">Cari sayur <div class="transition duration-300 ml-3 mt-1 w-3 h-3 border-t-2 border-r-2 rotate-45 border-green group-hover:border-white"></div></button></a>
        </div>
        <div class="flex justify-center items-center mt-8 max-w-screen-2xl">
          <img class="w-[700] lg:w-[55rem]" src="Section top.png" alt="section 1">
        </div>
      </div>
      ...
      <div id="Fitur unggulan" class="flex flex-col pt-32 mx-10 lg:mx-20">
        ...
        <div class="flex flex-wrap gap-5 lg:gap-10 justify-center lg:m-auto w-full">
          ...
          <div class="border border-2 lg:flex-1 xl:flex-1 rounded-2xl sm:mb-12 shadow-lg overflow-hidden">
            ...
            <div class="container font-sans">
              <h1 class="text-green text-4xl font-semibold mx-8 sm:mt-10 md:mt-10">Ambil sendiri</h1>
      ...
      <!-- hubungi kami -->
      <div id="Kontakkami" class="flex flex-col justify-center items-center pt-32 mx-10 lg:mx-10 mb-20">
        <div class="text-navy text-center text-6xl font-semibold md:mb-2 lg:mx-20 max-w-screen-2xl">
          <h1 style="font-family : 'Display Playfair', serif;">Hubungi <span class="text-green">kami</span></h1>
        </div>
        <div class="w-full border border-2 border-green rounded-2xl shadow-md m-8 mx-10 mt-24 lg:flex lg:flex-row lg:mb-40 lg:mx-20">
    ...
    <footer>
      ...
      <!-- bg element -->
      <div class="bg-green flex flex-col lg:flex lg:flex-row w-full">
        <div class="mx-12 my-6 lg:gap-y-8 justify-center items-center lg:mb-12 lg:mt-24 lg:mx-28">
          <div class="my-6 sm:flex sm:justify-center lg:justify-start">
            <img class="w-[40rem] lg:w-[20rem]" src="logo footer.svg">
          </div>
          <div class="flex flex-col justify-center lg:flex lg:flex-row lg:gap-4">
            ...
            <button class="border border-2 border-white shadow-lg rounded-lg px-32 py-4 bg-white hover:bg-green hover:text-white md:py-6 md:text-3xl lg:text-xl lg:px-6 lg:py-4 lg:my-4 transition duration-300">Kirim</button>
          </div>
        ...
        <div class="md:m-auto flex items-center lg:mt-24 lg:justify-end" style="font-family : 'inter', sans;">
          <div class="lg:flex lg:flex-col lg:justify-center lg:gap-y-10">
            <div class="flex flex-col text-white mx-12 lg:flex lg:flex-row lg:gap-16 md:flex md:flex-row md:flex-wrap md:justify-between lg:mx-24">
            ...
            <div class="my-8 mx-10 text-white text-xl font-normal leading-normal md:text-center lg:text-left lg:w-2/3 lg:text-2xl lg:mx-24 lg:my-8">
